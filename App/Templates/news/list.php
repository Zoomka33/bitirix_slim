                                ...
                                <div class="col-md-3">
                                    <div class="blog_info text-right">
                                        ...
                                        <ul class="blog_meta list">
                                            <li><a href="#">Автор: <?=$post['author']?><i class="lnr lnr-user"></i></a></li>
                                            <li><a href="#"><?=$post['date']?><i class="lnr lnr-calendar-full"></i></a></li>
                                            <li><a href="#"><?=$post['show']?><i class="lnr lnr-eye"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        ...
                                        <div class="blog_details">
                                            <a href="<?=View::route('news.detail', ['id' => $post['id']])?>">
                                                <h2><?=$post['title']?></h2>
                                            </a>
                                            <p><?=$post['text']?></p>
                                            <a href="<?=View::route('news.detail', ['id' => $post['id']])?>" class="white_bg_btn">View More</a>
                                        </div>
                                    </div>
                                </div>
                            </article>
